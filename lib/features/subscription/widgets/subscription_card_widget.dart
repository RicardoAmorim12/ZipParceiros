...
import 'package:fastdelivery_multivendor_restaurant/features/business/widgets/card_paint_widget.dart';
import 'package:fastdelivery_multivendor_restaurant/features/business/widgets/curve_clipper_widget.dart';
import 'package:fastdelivery_multivendor_restaurant/features/business/widgets/package_widget.dart';
...
class SubscriptionCardWidget extends StatelessWidget {
  ...
  final Color color;
  const SubscriptionCardWidget({super.key, required this.index, required this.package, required this.subscriptionController, required this.color});
