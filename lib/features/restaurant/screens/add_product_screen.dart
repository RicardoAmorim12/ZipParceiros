...
import 'package:fastdelivery_multivendor_restaurant/common/models/config_model.dart';
...
import 'package:fastdelivery_multivendor_restaurant/common/widgets/custom_time_picker_widget.dart';
import 'package:fastdelivery_multivendor_restaurant/common/widgets/custom_text_form_field_widget.dart';
...
import 'package:fastdelivery_multivendor_restaurant/features/restaurant/widgets/stock_section_widget.dart';
import 'package:fastdelivery_multivendor_restaurant/features/splash/controllers/splash_controller.dart';
import 'package:fastdelivery_multivendor_restaurant/features/restaurant/domain/models/variation_model.dart';
...
import 'package:fastdelivery_multivendor_restaurant/features/restaurant/widgets/variation_view_widget.dart';
...
class _AddProductScreenState extends State<AddProductScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    if(_update) {
      ...
      _stockTextController.text = _product!.itemStock == 0 ? '' : _product!.itemStock!.toString();
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          items: categoryController.categoryIds.map((int? value) {
                            return DropdownMenuItem<int>(
                              ...
                              child: Text(
                                ...
                                style: robotoRegular.copyWith(color: value != 0 ? Theme.of(context).textTheme.bodyLarge!.color : Theme.of(context).disabledColor),
                              ),
                            );
                          }).toList(),
                          onChanged: (int? value) {
                      ...
                      Row(children: [
                        ...
                        Expanded(child: RadioListTile<String>(
                          ...
                          activeColor: Theme.of(context).primaryColor,
                          dense: false,
                          fillColor: MaterialStateProperty.all(restController.isVeg ? Theme.of(context).primaryColor : Theme.of(context).disabledColor.withOpacity(0.6)),
                        )),
                    ...
                    child: Column(children: [
                      ...
                      Align(alignment: Alignment.center, child: Stack(children: [
                        ClipRRect(
                          ...
                          ) : _product!.image != null ? CustomImageWidget(
                        ...
                        Positioned(
                          ...
                          child: InkWell(
                            ...
                            child: DottedBorder(
                              ...
                              child: Center(
                                child: Visibility(
                                  visible: restController.pickedLogo != null || _product!.image != null ? true : false,
                                  child: Container(
