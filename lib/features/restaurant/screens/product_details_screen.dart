          ...
          return Column(children: [
            ...
            Expanded(child: SingleChildScrollView(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                (product.description != null && product.description!.isNotEmpty) ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Get.find<ProfileController>().profileModel!.restaurants![0].reviewsSection! ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
