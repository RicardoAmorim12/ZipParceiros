                    ...
                    InkWell(
                      ...
                      child: Row(
                        ...
                        Radio(
                          ...
                          activeColor: Theme.of(context).primaryColor,
                          fillColor: MaterialStateProperty.all(widget.restController.variationList![index].isSingle ? Theme.of(context).primaryColor : Theme.of(context).disabledColor.withOpacity(0.6)),
