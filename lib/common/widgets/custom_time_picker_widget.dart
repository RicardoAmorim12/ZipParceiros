        ...
        child: Stack(clipBehavior: Clip.none, children: [
          ...
          Container(
            ...
            child: Row(children: [
              ...
              Expanded(child: Text(
                _myTime != null ? DateConverter.convertStringTimeToTime(_myTime!) : ' - -  : - - ${'min'.tr}', style: robotoRegular.copyWith(color: _myTime != null ? Theme.of(context).textTheme.bodyLarge?.color : Theme.of(context).disabledColor),
              )),
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Text(widget.title, style: robotoRegular.copyWith(color: Theme.of(context).disabledColor)),
            ),
          ),
